    ...
    return (
        <footer className='bg-[#262626] text-white pt-16 pb-8'>
            <div className='container max-w-screen-xl m-auto grid grid-cols-4 gap-8 mb-16'>
                <div>
                    <img src="/public/Meubel House_Logos-05.svg" alt="" className='mb-4' />
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li className=' mb-4'><a href="">Privacy Policies</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul>
                        ...
                        <li className=' mb-4'><a href="">Udaipur, India- 313002</a></li>
