    ...
    return (
        <main className='max-w-screen-xl m-auto'>
            <section className='mt-16'>
                <div className=' grid grid-cols-2 gap-8 mb-16'>
                    ...
                    <div className='grid grid-cols-6 gap-8'>
                        <div className='col-span-1 *:mb-4'>
                            <img src="/public/Rectangle 307.jpg" alt="" />
                            <img src="/public/Rectangle 307.jpg" alt="" />
                            <img src="/public/Rectangle 307.jpg" alt="" />
                            <img src="/public/Rectangle 307.jpg" alt="" />
                            <img src="/public/Rectangle 307.jpg" alt="" />
                    ...
                    <div>
                        ...
                        <div className='flex items-center'>
                            <div className='flex items-center *:text-[#FFc700] border-r border-solid border-neutral-400 pr-4 mr-4'>
                                <span><IoIosStar /></span>
                                <span><IoIosStar /></span>
                                <span><IoIosStar /></span>
                                <span><IoIosStar /></span>
                ...
                <div>
                    <div className='*:font-semibold *:text-xl *:mr-16 border-b pb-4 mb-8'>
                        ...
                        <a href="" className='text-neutral-400'>Additional Information</a>
                        <a href="" className='text-neutral-400'>Reviews [5]</a>
                    </div>
                    <div className='*:text-[#a3a3a3] *:font-medium'>
                        ...
                        <div className='flex gap-8'>
                            <img src="/public/Rectangle 313.svg" alt="" />
                            <img src="/public/Rectangle 314.svg" alt="" />
                        </div>
                    </div>
                </div>
            </section>
            <section className=' my-16'>
                {/* product */}
                <div className='mb-4'>
                    <h2 className='font-semibold text-center text-[40px]'>Related Products</h2>
                </div>
